export default function itemReducer(state={id: null, name: "", price: null, description: "", user: {id: null}}, action) {
    switch (action.type) {
        ...
        case("SUCCESS_ITEM"):
            return { id: action.item.id, name: action.item.name, price: action.item.price, description: action.item.description, user: {...action.item.user}}
        case("FAILED_ITEM"):
                return {...state, messages: action.messages}
        case("LOGOUT_USER"):
            return {id: null, name: "", price: null, description: "", user: {id: null}}
        case("DROP_ITEM"):
            return  {id: null, name: "", price: null, description: "", user: {id: null}}
        default:
            return state
